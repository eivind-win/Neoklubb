...
<body>
    ...
    if (isset($_POST["SendMail"])) {
        try {
            ...
            $mail->addAddress("neoklubboe@gmail.com");
            $mail->Subject = $emne;
            $mail->Body = $mld;
            $mail->AltBody = $mld;
            $mail->send();
    ...
    <form method="POST" action="">
        ...
        <p>
            ...
            <input name="Melding" style="height:200px" type="text" required oninvalid="this.setCustomValidity('Meldingen kan ikke være blank!')" onchange="this.setCustomValidity('')">
        </p>
